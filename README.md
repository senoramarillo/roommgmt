...
## TODO: Fix Frontend issues, add Spring Security Features, pipeline not working, correct README ...
...
The final application should offer classic master data processing (CRUD) including some search operations via a
REST API.
